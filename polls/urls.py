...
urlpatterns = [
    ...
    path('reflection_edit/<int:pk>', views.ReflectionEditView.as_view(), name='reflection_edit'),
    path('plan_delete/<int:pk>', views.PlanDeleteView.as_view(), name='delete_plan'),
    path('reflection_delete/<int:pk>', views.ReflectionDeleteView.as_view(), name='delete_reflection'),
